    ...
    <div class="container">
        ...
        <div id="navigation">
            ...
            <ul class="navigation-menu nav-light">
                ...
                <li><a href="peraturan"
                        class="sub-menu-item {{ Request::is('*peraturan') ? 'active' : '' }}">Peraturan</a></li>
                <li><a href="peta" class="sub-menu-item {{ Request::is('peta') ? 'active' : '' }}">Peta Spasial</a>
                </li>
                <li><a href="statistik"
                        class="sub-menu-item {{ Request::is('*statistik') ? 'active' : '' }}">Statistik</a></li>
