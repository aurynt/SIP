            ...
            <div class="card h-100 p-4">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <div class="text-sm-left">
                                <a href="{{ route('page.peraturan') }}" class="btn btn-outline-secondary w-md"><i class="mdi mdi-arrow-left ml-1"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pb-5">
                        ...
                        <div class="col-6">
                            <embed type="application/pdf" src="assets/images/logo_kota_tegal.png" width="100%" height="700">
                        </div>
                    </div>
                </div>
            </div>
