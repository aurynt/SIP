...
class EditController extends Controller
{
    function editTanahLahan(Tanah $tanah, $id)
    {
        return view('admin.edit.editTanahDanLahanDashboard', [
            ...
            'data' => $tanah->select('tanah.*', 'ref_kecamatan.nama_kecamatan', 'ref_kelurahan.nama_kelurahan')
            ->join('ref_kecamatan', 'tanah.kode_kec', '=', 'ref_kecamatan.id_kecamatan')
            ->join('ref_kelurahan', 'tanah.kode_kel', '=', 'ref_kelurahan.id_kelurahan')
            ->findOrFail($id),
        ]);
    }
    function editRuasJalan(Jalan $jalan, $id)
    {
        return view('admin.edit.editRuasJalan', [
            ...
            'kecamatan' => DB::table('ref_kecamatan')->get(),
            'data' => $jalan->select('jalan.*', 'ref_kecamatan.nama_kecamatan', 'ref_kelurahan.nama_kelurahan')
